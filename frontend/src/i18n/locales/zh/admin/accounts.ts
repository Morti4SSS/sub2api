export default {
    accounts: {
      ...
      openai: {
        ...
        compactAdvancedTest: 'Compact 探测',
        compactTestEnabled: '正在发送 Compact 探测请求',
        compactTestHint: '仅用于 Codex /responses/compact 的高级探测。',
      ...
      testPromptPlaceholder: '请输入要向模型发送的完整问题。',
      testPromptHint: '至少输入 24 个字符的实质问题；禁止问候语和常见探活词。',
      defaultConnectionTestPrompt: '请简要说明如何确认本次模型请求已到达目标上游，并返回了有效且完整的响应。',
      testPromptProbeRejected: '请输入至少 24 个字符的完整问题，不能使用问候语或常见探活词。',
      testDiagnosticAccount: '固定账号',
      testDiagnosticClient: '客户端身份',
      testDiagnosticGateway: '网关路径',
      testDiagnosticModel: '请求模型 / 上游模型',
      testDiagnosticPassthrough: '自动透传',
      testDiagnosticHTTP: '上游状态',
      testDiagnosticErrorCode: '上游错误代码',
      testDiagnosticErrorReason: '上游错误原因',
