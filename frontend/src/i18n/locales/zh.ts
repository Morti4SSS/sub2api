export default {
  ...
  nav: {
    ...
    subscriptions: '订阅管理',
    accounts: '账号管理',
    openaiFreePools: 'OpenAI Free 分池',
    proxies: 'IP管理',
    redeemCodes: '兑换码',
    ops: '运维监控',
    promoCodes: '优惠码',
  ...
  admin: {
    ...
    dashboard: {
      ...
      openaiFreeResetForecast: {
        title: 'OpenAI Free 未来重置分布',
        description: '展示未来重置日期分布折线图，点击日期可展开查看账号明细。',
        ...
        usage: '7天用量',
        resetAt: '重置时间',
        empty: '未来窗口内暂无可展示的 OpenAI free 重置数据。',
        loadFailed: '加载 OpenAI free 重置分布失败'
      },
    ...
    openaiFreePools: {
      ...
      description: '集中查看建议迁移、五池分布与人工锁定管理。',
      configSummary: '配置摘要',
      statusSummary: '状态概览',
      managedSummary: '受管摘要',
      defaultGroup: 'Default 入口组',
      plusGroup: 'Plus 排除组',
      lookaheadDays: '预览窗口天数',
      managedAccounts: '受管账号',
      defaultAccounts: 'Default 待处理',
      unknownAccounts: 'Unknown 账号',
      preview: '生成预览',
      apply: '应用建议',
      forceRebalance: '强制重平衡',
      suggestions: '建议迁移',
      generatedAt: '生成时间',
      moveCount: '待迁移 {count} 条',
      noSuggestions: '暂无迁移建议',
      lockManagement: '锁定管理',
      noManagedAccounts: '暂无受管 OpenAI free 账号',
      account: '账号',
      currentGroup: '当前组',
      targetGroup: '目标组',
      currentProxy: '当前代理',
      ...
      loadFailed: '加载 OpenAI Free 分池页面失败',
      applyConfirm: '将应用 {count} 条建议迁移，是否继续？',
      applySuccess: '应用建议完成：成功 {applied}，失败 {failed}',
      applyFailed: '应用建议失败',
      lockSuccess: '分池锁定已更新',
      lockFailed: '分池锁定失败',
      unlockSuccess: '已解除人工锁定',
      unlockFailed: '解除人工锁定失败'
    },
    ...
    accounts: {
      ...
      segmentedRefresh: '分批刷新',
      segmentedRefreshTooltip: '分批刷新已选账号令牌',
      selectAccountsFirst: '请先选择账号',
      batchRefreshConfirmMessage: '将刷新 {count} 个已选账号',
      batchGroupSize: '每组账号数',
      batchGroupSizeHint: '范围 1-50；每组完成后才会进入下一组',
      delayMode: '间隔模式',
      delayModeFixed: '固定间隔',
      delayModeRandom: '随机间隔',
      batchGroupDelaySeconds: '组间延时（秒）',
      batchGroupDelaySecondsHint: '范围 0-600；只在两组之间等待，最后一组完成后不等待',
      minDelaySeconds: '最小延时（秒）',
      maxDelaySeconds: '最大延时（秒）',
      batchProgressPreview: '将处理 {count} 个账号，共 {groups} 组；每组 {size} 个，组间隔 {delay} 秒。',
      batchProgressActive: '正在处理第 {current}/{total} 组，成功 {success}，失败 {failed}，状态：{status}',
      batchProgressRunning: '执行中',
      batchProgressWaiting: '等待下一组',
      batchProgressStopping: '停止中',
      batchStop: '停止后续分组',
      batchStopRequested: '已请求停止',
      batchStopped: '批量刷新已停止，已保留结果：成功 {success}，失败 {failed}',
      batchRefreshConcurrency: '同时刷新数量',
      batchRefreshConcurrencyHint: '范围 1-10；1 表示一个账号刷新完成后再刷新下一个',
      ...
      openaiFreePool: {
        title: 'OpenAI Free 自动分池',
        description: '基于 default 入口组生成五个 free 分组的稳定分配预览。',
        configSummary: '配置摘要',
        statusSummary: '状态摘要',
        poolBindings: '五池与代理绑定',
        defaultGroup: 'Default 入口组',
        plusGroup: 'Plus 排除组',
        lookaheadDays: '预览窗口天数',
        managedAccounts: '受管账号',
        ...
        preview: '生成预览',
        apply: '应用建议',
        applyConfirm: '将应用 {count} 条分池建议，是否继续？',
        applySuccess: '分池应用完成：成功 {applied}，失败 {failed}',
        applyFailed: '应用分池建议失败',
        loadFailed: '加载 OpenAI free 自动分池面板失败',
        account: '账号',
        currentGroup: '当前组',
        targetGroup: '目标组',
        currentProxy: '当前代理',
        ...
        nextReset: 'Next Reset',
        reason: '变更原因',
        noMoves: '当前没有需要应用的迁移建议。',
        unassignedProxy: '未绑定代理',
        accountsCount: '{count} 个账号',
        lockedCount: '锁定 {count}',
        unknown: 'Unknown',
        locked: '已锁定',
        lockOpenAIFreePool: '分池锁定',
        unlockOpenAIFreePool: '解除人工锁定',
        reasons: {
      ...
      tokenRefresh: {
        ...
        rtRotated: 'RT已轮换',
        rtUnchanged: 'RT未变化',
        rtPreserved: 'RT未返回，保留旧RT',
        rtMissing: 'RT缺失',
        rtSaveFailed: 'RT保存失败',
        highRisk: '高风险：请手动刷新验证',
        watch: '观察：RT未轮换',
        sourceBackground: '后台巡检',
        sourceManualSingle: '手动单号',
        sourceManualBatch: '手动批量',
        sourceRequest: '请求触发'
      },
      ...
      bulkActions: {
        ...
        singleRefreshSuccess: '账号 {name} 刷新令牌成功',
        singleRefreshFailed: '刷新账号令牌失败',
        partialSuccess: '操作部分完成：{success} 成功，{failed} 失败'
      },
      staggeredProbe: {
        title: '随机探活',
        confirmMessage: '将从 {count} 个已选账号中过滤候选账号并分段探活',
        start: '开始探活',
        running: '探活中...',
        hide: '隐藏',
        recentHours: '跳过最近活跃/探活（小时）',
        recentHoursHint: '最近使用过或最近探活过的账号会跳过；默认 24 小时，避免反复探活。',
        fixedDelay: '固定间隔（分钟）',
        minDelay: '最小间隔（分钟）',
        maxDelay: '最大间隔（分钟）',
        delayHint: '固定/随机间隔只作用在两个账号之间；最后一个账号完成后不等待。',
        modelHint: '仅探活 OpenAI/GPT/Codex 账号；优先 Codex 模型，其次 GPT-5 系列，否则使用模型列表第一个。',
        preview: '已选 {selected} 个，候选 {candidates} 个，跳过 {skipped} 个。',
        skipBreakdown: '跳过明细：最近使用 {recentlyUsed}，最近探活 {recentlyProbed}，不可调度 {unschedulable}。',
        progress: '正在探活 {current}/{total}，成功 {success}，失败 {failed}，跳过 {skipped}，状态：{status}',
        waiting: '等待下一次探活',
        resultSuccessWithModel: '成功，模型：{model}',
        resultFailed: '探活失败',
        noModel: '没有可用模型',
        noCandidates: '没有需要探活的候选账号',
        done: '随机探活完成：成功 {success}，跳过 {skipped}',
        doneWithFailures: '随机探活完成：成功 {success}，失败 {failed}，跳过 {skipped}',
        viewDetails: '查看详情'
      },
      bulkEdit: {
        title: '批量编辑账号',
      ...
      anthropic: {
        ...
        claudeCodeMapping: 'Claude Code CLI 模型映射',
        claudeCodeMappingDesc: '让 Claude Code 的 /model 显示自定义模型名，并在转发到上游前映射模型和思考强度。',
        claudeCodeRole: '模型角色',
        claudeCodeDisplayName: '显示名称',
        claudeCodeRequestModel: '实际请求模型',
        claudeCodeUpstreamModel: '上游模型',
        claudeCodeSupports1m: '声明支持 1M',
        claudeCodeCapabilities: '能力声明',
        claudeCodeAddModel: '添加 Claude Code 模型',
        claudeCodeModelPreview: 'CC /model 显示：{visible}；请求模型：{requestModel}；上游模型：{upstream}',
        claudeCodeEffortMapping: '思考强度映射',
        claudeCodeEffortModel: 'Claude Code 模型',
        claudeCodeEffortTarget: '上游字段',
        claudeCodeEffortSummary: '档位映射：{summary}',
        claudeCodeAddEffort: '添加思考强度映射',
      },
