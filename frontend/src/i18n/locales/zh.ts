export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      testPromptHint: '用于真实问答测试；不要使用 hi、hello、ping、test 等探活词。',
      defaultConnectionTestPrompt: '请用一句完整的话说明可靠的 API 连接为什么重要。',
      testPromptProbeRejected: '测试词必须是完整问题，不能使用 hi、hello、ping 或 test。',
