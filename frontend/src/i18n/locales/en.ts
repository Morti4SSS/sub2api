export default {
  ...
  nav: {
    ...
    accounts: 'Accounts',
    openaiFreePools: 'OpenAI Free Pools',
    proxies: 'Proxies',
  ...
  admin: {
    ...
    dashboard: {
      ...
      openaiFreeResetForecast: {
        title: 'OpenAI Free Reset Forecast',
        description: 'Shows an upcoming reset line chart and lets you expand account details by date.',
        ...
        usage: '7d Usage',
        resetAt: 'Reset At',
        empty: 'No OpenAI free reset data is available in the current lookahead window.',
        loadFailed: 'Failed to load OpenAI free reset forecast'
      },
    ...
    openaiFreePools: {
      title: 'OpenAI Free Pools',
      description: 'Manage suggested moves, five-pool distribution, and manual locks in one place.',
      configSummary: 'Config Summary',
      statusSummary: 'Status Summary',
      managedSummary: 'Managed Summary',
      defaultGroup: 'Default Intake Group',
      plusGroup: 'Plus Exclusion Group',
      lookaheadDays: 'Lookahead Days',
      managedAccounts: 'Managed Accounts',
      defaultAccounts: 'Default Pending',
      ...
      moveCount: '{count} moves pending',
      noSuggestions: 'No move suggestions right now',
      lockManagement: 'Lock Management',
      noManagedAccounts: 'No managed OpenAI free accounts',
      account: 'Account',
      ...
      lockModeLocked: 'Locked',
      lockModeUnlocked: 'Unlocked',
      lockModeAuto: 'Auto',
      lockModeManual: 'Manual',
      lockToGroup: 'Manually Pin To Pool',
      unlockManual: 'Unlock Manual Lock',
      lockedProxy: 'Mapped Proxy',
      filters: {
        all: 'All'
      },
      loadFailed: 'Failed to load OpenAI Free Pools page',
      applyConfirm: 'Apply {count} suggested moves?',
      applySuccess: 'Finished applying suggestions: {applied} applied, {failed} failed',
      applyFailed: 'Failed to apply suggestions',
      lockSuccess: 'Pool lock updated',
      lockFailed: 'Failed to update pool lock',
      unlockSuccess: 'Manual lock removed',
      unlockFailed: 'Failed to remove manual lock'
    },
    ...
    accounts: {
      ...
      segmentedRefresh: 'Segmented Refresh',
      segmentedRefreshTooltip: 'Refresh selected account tokens in batches',
      selectAccountsFirst: 'Please select accounts first',
      batchRefreshConfirmMessage: 'Will refresh {count} selected account(s)',
      batchGroupSize: 'Accounts per group',
      batchGroupSizeHint: 'Range 1-50; the next group starts only after the current group finishes',
      delayMode: 'Delay mode',
      delayModeFixed: 'Fixed interval',
      delayModeRandom: 'Random interval',
      batchGroupDelaySeconds: 'Delay between groups (seconds)',
      batchGroupDelaySecondsHint: 'Range 0-600; waits only between groups, not after the final group',
      minDelaySeconds: 'Min delay (seconds)',
      maxDelaySeconds: 'Max delay (seconds)',
      batchProgressPreview: 'Will process {count} account(s) in {groups} group(s); {size} per group, {delay}s between groups.',
      batchProgressActive: 'Processing group {current}/{total}, success {success}, failed {failed}, status: {status}',
      batchProgressRunning: 'running',
      batchProgressWaiting: 'waiting for next group',
      batchProgressStopping: 'stopping',
      batchStop: 'Stop Remaining Groups',
      batchStopRequested: 'Stop Requested',
      batchStopped: 'Batch refresh stopped. Kept results: {success} succeeded, {failed} failed',
      batchRefreshConcurrency: 'Concurrent refresh count',
      batchRefreshConcurrencyHint: 'Range 1-10; 1 refreshes the next account only after the previous one finishes',
      ...
      openaiFreePool: {
        title: 'OpenAI Free Auto Pooling',
        description: 'Preview stable placement from the default intake group into the five free pools.',
        configSummary: 'Config Summary',
        statusSummary: 'Status Summary',
        ...
        preview: 'Preview',
        apply: 'Apply',
        applyConfirm: 'Apply {count} proposed pool moves?',
        applySuccess: 'Pool apply finished: {applied} applied, {failed} failed',
        applyFailed: 'Failed to apply pool suggestions',
        loadFailed: 'Failed to load OpenAI free auto pool panel',
        account: 'Account',
        currentGroup: 'Current Group',
        targetGroup: 'Target Group',
        currentProxy: 'Current Proxy',
        ...
        nextReset: 'Next Reset',
        reason: 'Reason',
        noMoves: 'No pool moves are currently required.',
        unassignedProxy: 'Unassigned Proxy',
        accountsCount: '{count} accounts',
        lockedCount: 'Locked {count}',
        unknown: 'Unknown',
        locked: 'Locked',
        lockOpenAIFreePool: 'Pool Lock',
        unlockOpenAIFreePool: 'Unlock Manual Lock',
        reasons: {
      ...
      tokenRefresh: {
        atExpires: 'AT Expires',
        windowStarts: 'Refresh Window',
        lastRefresh: 'Last Refresh',
        lastSuccess: 'Last Success',
        lastAttempt: 'Last Attempt',
        source: 'Source',
        result: 'Result',
        pending: 'No refresh record',
        checked: 'Checked',
        failed: 'Refresh failed',
        rtSaved: 'RT saved',
        rtRotated: 'RT rotated',
        rtUnchanged: 'RT unchanged',
        rtPreserved: 'RT not returned, old RT kept',
        rtMissing: 'RT missing',
        rtSaveFailed: 'RT save failed',
        highRisk: 'High risk: verify manually',
        watch: 'Watch: RT unchanged',
        sourceBackground: 'Background',
        sourceManualSingle: 'Manual single',
        sourceManualBatch: 'Manual batch',
        sourceRequest: 'Request trigger'
      },
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        staggeredProbe: 'Random Probe',
        resetStatusSuccess: 'Successfully reset {count} account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {count} account(s) token',
        singleRefreshSuccess: 'Successfully refreshed token for {name}',
        singleRefreshFailed: 'Failed to refresh account token',
        partialSuccess: 'Partially completed: {success} succeeded, {failed} failed'
      },
      staggeredProbe: {
        title: 'Random Probe',
        confirmMessage: 'Will filter candidate accounts from {count} selected account(s) and probe them in staggered order',
        start: 'Start Probe',
        running: 'Probing...',
        hide: 'Hide',
        recentHours: 'Skip recent activity/probes (hours)',
        recentHoursHint: 'Accounts used recently or probed recently are skipped; default is 24 hours to avoid repeated probes.',
        fixedDelay: 'Fixed interval (minutes)',
        minDelay: 'Min interval (minutes)',
        maxDelay: 'Max interval (minutes)',
        delayHint: 'Fixed/random delay is applied only between accounts, not after the final account.',
        modelHint: 'Only OpenAI/GPT/Codex accounts are probed; Codex models are preferred, then GPT-5 models, otherwise the first listed model.',
        preview: '{selected} selected, {candidates} candidate(s), {skipped} skipped.',
        skipBreakdown: 'Skipped breakdown: {recentlyUsed} recently used, {recentlyProbed} recently probed, {unschedulable} unschedulable.',
        progress: 'Probing {current}/{total}, success {success}, failed {failed}, skipped {skipped}, status: {status}',
        waiting: 'waiting for next probe',
        resultSuccessWithModel: 'Success, model: {model}',
        resultFailed: 'Probe failed',
        noModel: 'No available model',
        noCandidates: 'No candidate accounts need probing',
        done: 'Random probe completed: {success} succeeded, {skipped} skipped',
        doneWithFailures: 'Random probe completed: {success} succeeded, {failed} failed, {skipped} skipped',
      ...
      anthropic: {
        ...
        claudeCodeMapping: 'Claude Code CLI model mapping',
        claudeCodeMappingDesc:
          'Show custom model names in Claude Code /model, then map models and thinking effort before forwarding upstream.',
        claudeCodeRole: 'Model role',
        claudeCodeDisplayName: 'Display name',
        claudeCodeRequestModel: 'Request model',
        claudeCodeUpstreamModel: 'Upstream model',
        claudeCodeSupports1m: 'Declare 1M support',
        claudeCodeCapabilities: 'Capabilities',
        claudeCodeAddModel: 'Add Claude Code model',
        claudeCodeModelPreview: 'CC /model shows: {visible}; request model: {requestModel}; upstream model: {upstream}',
        claudeCodeEffortMapping: 'Thinking effort mapping',
        claudeCodeEffortModel: 'Claude Code model',
        claudeCodeEffortTarget: 'Upstream field',
        claudeCodeEffortSummary: 'Effort mapping: {summary}',
        claudeCodeAddEffort: 'Add effort mapping',
      },
