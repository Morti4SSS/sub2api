  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        compactAdvancedTest: 'Codex advanced test',
        compactTestEnabled: 'Test the /responses/compact endpoint',
        compactTestHint: 'Checks Compact endpoint support only; it does not run the normal question test.',
      ...
      anthropic: {
        ...
        claudeCodeMapping: 'Claude Code model and effort mapping',
        claudeCodeMappingDesc:
          'Generic config for Claude Code /model display and mapping low/medium/high/xhigh/max to the upstream effort field and values.',
        claudeCodeRole: 'Role',
        claudeCodeDisplayName: 'Display name',
        claudeCodeRequestModel: 'Claude Code request model',
        claudeCodeUpstreamModel: 'Upstream model',
        claudeCodeSupports1m: 'Supports 1M context',
        claudeCodeCapabilities: 'Capability tags',
        claudeCodeModelPreview: '/model shows {visible}; request {requestModel}; forwards {upstream}',
        claudeCodeAddModel: 'Add model mapping',
        claudeCodeSyncModels: 'Sync upstream models',
        claudeCodeSyncModelsLoading: 'Syncing...',
        claudeCodeSyncModelsSuccess: 'Loaded {count} upstream model(s) for the upstream model field',
        claudeCodeSyncModelsFailed: 'Failed to sync upstream models; you can still enter a model manually',
        claudeCodeModelSyncAdvanced: 'Model sync advanced settings',
        claudeCodeModelsURL: 'Custom model-list endpoint',
        claudeCodeModelsURLPlaceholder: 'Leave empty to derive /v1/models from the Base URL',
        claudeCodeEffortMapping: 'Reasoning effort mapping',
        claudeCodeEffortModel: 'Request model',
        claudeCodeEffortTarget: 'Upstream target field',
        claudeCodeEffortSummary: 'Folded levels: {summary}',
        claudeCodeAddEffort: 'Add effort mapping',
        claudeCodeContextWindow: 'Context window',
        claudeCodeContextPreset: 'Preset',
        claudeCodeThinkingEnabled: 'Map reasoning effort',
        claudeCodeThinkingMode: 'Mapping mode',
        claudeCodeThinkingModeLevels: 'Ordered levels',
        claudeCodeThinkingModeBudget: 'Token budgets',
        claudeCodeOrderedLevels: 'Upstream levels (weak to strong)',
        claudeCodeOrderedBudgets: 'Token budgets (low to high)',
        claudeCodeOverrides: 'Per-level overrides',
        claudeCodeAdvancedSettings: 'Advanced settings',
      },
      ...
      testPrompt: 'Complete question test',
      testPromptLabel: 'Test prompt',
      testPromptPlaceholder: 'Enter a complete question',
      testPromptHint: 'Used for a real question test; enter a complete question with at least 24 characters, not a greeting or probe word such as hi, hello, ping, or test.',
      defaultConnectionTestPrompt: 'Please explain in two concise sentences how you would distinguish a successful model response, a missing model route, and an upstream rate-limit error.',
      testPromptProbeRejected: 'The test prompt must contain at least 24 characters and cannot be only a greeting or probe word such as hi, hello, ping, or test.',
      testDiagnosticAccount: 'Fixed account',
      testDiagnosticClient: 'Client identity',
      testDiagnosticGateway: 'Gateway path',
      testDiagnosticModel: 'Model mapping',
