export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      testPromptHint: 'Used for a real question test; do not use hi, hello, ping, or test.',
      defaultConnectionTestPrompt: 'In one complete sentence, explain why a reliable API connection matters.',
      testPromptProbeRejected: 'The test prompt must be a complete question, not hi, hello, ping, or test.',
