export default {
    accounts: {
      ...
      openai: {
        ...
        compactAdvancedTest: 'Compact probe',
        compactTestEnabled: 'Sending Compact probe request',
        compactTestHint: 'Advanced Codex-only probe for /responses/compact.',
      ...
      testPromptLabel: 'Test question',
      testPromptPlaceholder: 'Enter a complete question for the model.',
      testPromptHint: 'Use a substantive question of at least 24 characters. Greeting and probe words are rejected.',
      defaultConnectionTestPrompt: 'Please explain how to verify that this model request reached the intended upstream service and returned a valid response.',
      testPromptProbeRejected: 'Enter a complete question of at least 24 characters; greetings and probe words are not allowed.',
      testDiagnosticAccount: 'Fixed account',
      testDiagnosticClient: 'Client identity',
      testDiagnosticGateway: 'Gateway path',
      testDiagnosticModel: 'Requested / upstream model',
      testDiagnosticPassthrough: 'Passthrough',
      testDiagnosticHTTP: 'Upstream status',
      testDiagnosticErrorCode: 'Upstream error code',
      testDiagnosticErrorReason: 'Upstream error reason',
